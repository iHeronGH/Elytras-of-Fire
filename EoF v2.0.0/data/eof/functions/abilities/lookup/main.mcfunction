...
execute unless entity @s run tellraw @a[tag=eoflib.debug, scores={eoflib.debug_mode=2..}] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eof:lookup/main.mcf", "color": "gray", "hoverEvent": {"action": "show_text", "value": {"text": "Server executed the following function:\n- data/eof/functions/abilities/lookup/main.mcfunction", "color": "aqua"}}}]
    ...
    # Test
execute if predicate eoflib:abilities/primary_used run function eof:abilities/lookup/primary
execute if predicate eoflib:abilities/secondary_used run function eof:abilities/lookup/secondary
execute if predicate eoflib:abilities/tertiary_used run function eof:abilities/lookup/tertiary
