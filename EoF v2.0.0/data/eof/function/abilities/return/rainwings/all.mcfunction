...
execute unless data storage eoflib:config eoflib.admin_settings.blacklist.archetype[{"eof_data": {"ability_data": {archetype: "primary"}}}] unless data storage eoflib:config eoflib:admin_settings.blacklist.ability[{"eof_data": {"ability_data": {name: "venom_shot"}}}] run clear @s #eoflib:items[minecraft:custom_data~{"eof_data": {"ability_data": {name: "venom_shot"}}}]
execute unless data storage eoflib:config eoflib.admin_settings.blacklist.archetype[{"eof_data": {"ability_data": {archetype: "secondary"}}}] unless data storage eoflib:config eoflib:admin_settings.blacklist.ability[{"eof_data": {"ability_data": {name: "overgrowth"}}}] run clear @s #eoflib:items[minecraft:custom_data~{"eof_data": {"ability_data": {name: "overgrowth"}}}]
execute unless data storage eoflib:config eoflib.admin_settings.blacklist.archetype[{"eof_data": {"ability_data": {archetype: "tertiary"}}}] unless data storage eoflib:config eoflib:admin_settings.blacklist.ability[{"eof_data": {"ability_data": {name: "soul_sap"}}}] run clear @s #eoflib:items[minecraft:custom_data~{"eof_data": {"ability_data": {name: "soul_sap"}}}]
