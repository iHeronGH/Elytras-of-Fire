...
execute unless entity @s[predicate=!eoflib:abilities/primary_activated, predicate=!eoflib:abilities/primary_used] if entity @s[predicate=eof:tribes/pyrrhian, predicate=!eof:abilities/cooldowns/primaries] run function eof:abilities/lookup/primary
execute unless entity @s[predicate=!eoflib:abilities/secondary_activated, predicate=!eoflib:abilities/secondary_used] if entity @s[predicate=eof:tribes/pyrrhian, predicate=!eof:abilities/cooldowns/primaries] run function eof:abilities/lookup/secondary
execute unless entity @s[predicate=!eoflib:abilities/tertiary_activated, predicate=!eoflib:abilities/tertiary_used] if entity @s[predicate=eof:tribes/pyrrhian, predicate=!eof:abilities/cooldowns/primaries] run function eof:abilities/lookup/tertiary
