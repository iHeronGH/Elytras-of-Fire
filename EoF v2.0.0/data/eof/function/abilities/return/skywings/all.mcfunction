...
execute if entity @s at @s run tellraw @a[tag=eoflib.debug, scores={eoflib.debug_mode=3..}, distance=0.1..] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eof:skywings/all.mcf", "color": "#967228", "hoverEvent": {"action": "show_text", "value": [{"selector": "@s", "color": "aqua"}, {"text": " ran the following function:\n- eof:abilities/return/skywings/all.mcfunction", "color": "aqua"}]}}]
...
execute unless data storage eoflib:config eoflib.admin_settings.blacklist.archetype[{"eof_data": {"ability_data": {archetype: "secondary"}}}] unless data storage eoflib:config eoflib:admin_settings.blacklist.ability[{"eof_data": {"ability_data": {name: "sky_surge"}}}] run clear @s #eoflib:items[minecraft:custom_data~{"eof_data": {"ability_data": {name: "sky_surge"}}}]
execute unless data storage eoflib:config eoflib.admin_settings.blacklist.archetype[{"eof_data": {"ability_data": {archetype: "tertiary"}}}] unless data storage eoflib:config eoflib:admin_settings.blacklist.ability[{"eof_data": {"ability_data": {name: "spark_punch"}}}] run clear @s #eoflib:items[minecraft:custom_data~{"eof_data": {"ability_data": {name: "spark_punch"}}}]
