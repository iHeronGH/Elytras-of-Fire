...
execute if entity @s at @s run tellraw @a[tag=eoflib.debug, scores={eoflib.debug_mode=3..}, distance=0.1..] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eof:ability_data/icewings.mcf", "color": "#967228", "hoverEvent": {"action": "show_text", "value": [{"selector": "@s", "color": "aqua"}, {"text": " ran the following function:\n- eof:load/gen/storages/ability_data/icewings.mcfunction", "color": "aqua"}]}}]
...
data modify storage eoflib:config eof.Abilities[].IceWings.primary[0].eof_data set value { \
    ...
    "ability_data": { \
        ...
        "format": { \
            ...
            "archetype": '{"text": "Primary (Straight, 13)", "color": "gray", "italic": false}', \
