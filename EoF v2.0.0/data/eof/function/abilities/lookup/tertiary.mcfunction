...
execute if entity @s[predicate=eof:abilities/criteria/nightwings/premonition, predicate=!eof:abilities/cooldowns/nightwings/premonition/on_cooldown] run function eof:abilities/activate/nightwings/premonition/activate
...
execute if entity @s[tag=eoflib.silly_goofy_mode] if score @s eoflib.silly_goofy_mode matches ..5 run function eoflib:load/silly_goofy_mode/randomise_ability_slot/tertiary
