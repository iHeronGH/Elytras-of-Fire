...
execute if entity @s at @s run tellraw @a[tag=eoflib.debug, scores={eoflib.debug_mode=3..}, distance=0.1..] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eof:mudwings/flame_breath.mcf", "color": "gold", "hoverEvent": {"action": "show_text", "value": [{"selector": "@s", "color": "aqua"}, {"text": " ran the following function:\n- eof:abilities/activate/mudwings/flame_breath.mcfunction", "color": "aqua"}]}}]
...
scoreboard players operation @s[tag=!eoflib.cooldown.bypass] eof.abilities.mudwing_flame_breath = #cooldown eof.abilities.mudwing_flame_breath
