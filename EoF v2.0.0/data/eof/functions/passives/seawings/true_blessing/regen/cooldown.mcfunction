...
execute as @a[tag=eof.passives.true_blessing.regen.active, scores={eof.passives.true_blessing.regen=..0}] run function eof:passives/seawings/true_blessing/regen/deactivate
        ...
        ## On Success
execute if entity @a[tag=eof.passives.true_blessing.regen.active, scores={eof.passives.true_blessing.regen=0..800}] run schedule function eof:passives/seawings/true_blessing/regen/cooldown 1t
