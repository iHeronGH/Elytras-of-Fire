...
#region
    # Debug
execute if entity @s run tellraw @s[tag=eoflib.debug] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eof:scoreboards/ability_variables.mcf", "color": "gold", "hoverEvent": {"action": "show_text", "value": {"text": "You executed the following function:\n\ndata/eof/functions/load/gen/scoreboards/ability_variables.mcfunction", "color": "aqua"}}}]
execute unless entity @s run tellraw @a[tag=eoflib.debug] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eof:scoreboards/ability_variables.mcf", "color": "gray", "hoverEvent": {"action": "show_text", "value": {"text": "Server executed the following function:\n\ndata/eof/functions/load/gen/scoreboards/ability_variables.mcfunction", "color": "aqua"}}}]

    # Ability variables
        ## Primary
            ### Frost Breath
#define score_holder #eof.abilities.frost_breath.cooldown Sets the cooldown for Frost Breath.
execute store result score #eof.abilities.frost_breath.cooldown eof.abilities.frost_breath run data get storage eoflib:config eof.Abilities[].IceWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.frost_breath.duration Sets the duration for Frost Breath.
execute store result score #eof.abilities.frost_breath.duration eof.abilities.frost_breath run data get storage eoflib:config eof.Abilities[].IceWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.mudwing_flame_breath.cooldown eof.abilities.mudwing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.mudwing_flame_breath.duration Sets the duration for MudWing Flame Breath.
execute store result score #eof.abilities.mudwing_flame_breath.duration eof.abilities.mudwing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.nightwing_flame_breath.cooldown eof.abilities.nightwing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.nightwing_flame_breath.duration Sets the duration for NightWing Flame Breath.
execute store result score #eof.abilities.nightwing_flame_breath.duration eof.abilities.nightwing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.venom_shot.cooldown eof.abilities.venom_shot run data get storage eoflib:config eof.Abilities[].RainWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.venom_shot.duration Sets the duration for Venom Shot.
execute store result score #eof.abilities.venom_shot.duration eof.abilities.venom_shot run data get storage eoflib:config eof.Abilities[].RainWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.sandwing_flame_breath.cooldown eof.abilities.sandwing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.sandwing_flame_breath.duration Sets the duration for SandWing Flame Breath.
execute store result score #eof.abilities.sandwing_flame_breath.duration eof.abilities.sandwing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.tidal_wave.cooldown eof.abilities.tidal_wave run data get storage eoflib:config eof.Abilities[].SeaWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.tidal_wave.duration Sets the duration for Tidal Wave.
execute store result score #eof.abilities.tidal_wave.duration eof.abilities.tidal_wave run data get storage eoflib:config eof.Abilities[].SeaWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.skywing_flame_breath.cooldown eof.abilities.skywing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.skywing_flame_breath.duration Sets the duration for SkyWing Flame Breath.
execute store result score #eof.abilities.skywing_flame_breath.duration eof.abilities.skywing_flame_breath run data get storage eoflib:config eof.Abilities[].MudWings[].primary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.serrated_strike.cooldown eof.abilities.serrated_strike run data get storage eoflib:config eof.Abilities[].IceWings[].secondary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.serrated_strike.duration Sets the duration for Serrated Strike.
execute store result score #eof.abilities.serrated_strike.duration eof.abilities.serrated_strike run data get storage eoflib:config eof.Abilities[].IceWings[].secondary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.terrashock.cooldown eof.abilities.terrashock run data get storage eoflib:config eof.Abilities[].MudWings[].secondary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.terrashock.duration Sets the duration for Terrashock.
execute store result score #eof.abilities.terrashock.duration eof.abilities.terrashock run data get storage eoflib:config eof.Abilities[].MudWings[].secondary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.overgrowth.cooldown eof.abilities.overgrowth run data get storage eoflib:config eof.Abilities[].RainWings[].secondary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.overgrowth.duration Sets the duration for Overgrowth.
execute store result score #eof.abilities.overgrowth.duration eof.abilities.overgrowth run data get storage eoflib:config eof.Abilities[].RainWings[].secondary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.desert_storm.cooldown eof.abilities.desert_storm run data get storage eoflib:config eof.Abilities[].SandWings[].secondary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.desert_storm.duration Sets the duration for Desert Storm.
execute store result score #eof.abilities.desert_storm.duration eof.abilities.desert_storm run data get storage eoflib:config eof.Abilities[].SandWings[].secondary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.sky_surge.cooldown eof.abilities.sky_surge run data get storage eoflib:config eof.Abilities[].SkyWings[].secondary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.sky_surge.duration Sets the duration for Sky Surge.
execute store result score #eof.abilities.sky_surge.duration eof.abilities.sky_surge run data get storage eoflib:config eof.Abilities[].SkyWings[].secondary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.mud_swipe.cooldown eof.abilities.mud_swipe run data get storage eoflib:config eof.Abilities[].MudWings[].tertiary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.mud_swipe.duration Sets the duration for Mud Swipe.
execute store result score #eof.abilities.mud_swipe.duration eof.abilities.mud_swipe run data get storage eoflib:config eof.Abilities[].MudWings[].tertiary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.premonition.cooldown eof.abilities.premonition run data get storage eoflib:config eof.Abilities[].NightWings[].tertiary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.premonition.duration Sets the duration for Premonition.
execute store result score #eof.abilities.premonition.duration eof.abilities.premonition run data get storage eoflib:config eof.Abilities[].NightWings[].tertiary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.soul_sap.cooldown eof.abilities.soul_sap run data get storage eoflib:config eof.Abilities[].RainWings[].tertiary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.soul_sap.duration Sets the duration for Soul Sap.
execute store result score #eof.abilities.soul_sap.duration eof.abilities.soul_sap run data get storage eoflib:config eof.Abilities[].RainWings[].tertiary[].eof_data.ability_data.duration 20
...
execute store result score #eof.abilities.tail_flail.cooldown eof.abilities.tail_flail run data get storage eoflib:config eof.Abilities[].SeaWings[].tertiary[].eof_data.ability_data.cooldown 20

#define score_holder #eof.abilities.tail_flail.duration Sets the duration for Tail Flail.
execute store result score #eof.abilities.tail_flail.duration eof.abilities.tail_flail run data get storage eoflib:config eof.Abilities[].SeaWings[].tertiary[].eof_data.ability_data.duration 20
