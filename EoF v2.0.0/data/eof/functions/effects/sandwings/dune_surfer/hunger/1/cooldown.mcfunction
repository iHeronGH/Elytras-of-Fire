...
execute as @a[tag=eof.passives.dune_surfer.hunger, scores={eof.passives.dune_surfer.hunger=..0}] run function eof:effects/sandwings/dune_surfer/hunger/1/deactivate
        ...
        ## On Success
execute if entity @a[tag=eof.passives.dune_surfer.hunger, scores={eof.passives.dune_surfer.hunger=0..800}] run schedule function eof:effects/sandwings/dune_surfer/hunger/1/cooldown 1t
