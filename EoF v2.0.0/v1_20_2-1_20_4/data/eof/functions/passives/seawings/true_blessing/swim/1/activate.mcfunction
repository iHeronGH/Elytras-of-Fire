...
title @s actionbar {"text": "True Blessing charged!", "color": "dark_aqua"}
    ...
    # Effect entities
tag @s add eof.passives.true_blessing.swim.active
function eof:passives/seawings/true_blessing/swim/1
